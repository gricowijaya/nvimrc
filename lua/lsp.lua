...
buf_set_keymap('n', '<space>wa', '<cmd>lua vim.lsp.buf.add_workspace_folder()<CR>', opts)
        ...
        buf_set_keymap('n', '<space>D', '<cmd>lua vim.lsp.buf.type_definition()<CR>', opts) -- code documentation
        buf_set_keymap('n', '<space>C', '<cmd>terminal gcc main.c -o main; ./main<CR>', opts) -- code documentation
    buf_set_keymap('n', '<space>r', '<cmd>terminal go run main.go<CR>', opts) -- code documentation
